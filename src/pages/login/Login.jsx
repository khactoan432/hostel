            ...
            music.
                                    ...
                                    <form onSubmit={handleSubmit(submitHandler)}>
                                          ...
                                          <div className='flex flex-col items-center justify-between mt-6 space-y-6  md:flex-row md:space-y-0 md:space-x-6'>
                                                <button
                                                      type='submit'
                                                      className='w-full md:w-auto flex justify-center items-center p-4 space-x-2 font-sans font-bold text-white rounded-md px-9 background-primary shadow-cyan-100 hover:bg-opacity-90 shadow-sm hover:shadow-lg border transition hover:-translate-y-0.5 duration-150'
                                                >
                                                      {isPending ? (
                                                            <>
                                                                  <svg
                                                ...
                                                <Link to='/register'>
                                                      <button
                                                            type='button'
                                                            className='w-full md:w-auto flex justify-center items-center p-4 space-x-2 font-sans font-bold text-hostel bg-white rounded-md px-9 shadow-cyan-100 hover:bg-opacity-90 shadow-sm hover:shadow-lg border transition hover:-translate-y-0.5 duration-150'
                                                      >
                                                            Đăng ký
                                                      </button>
                                                </Link>
                                    ...
                                    <div className='font-regular text-hostel hover:cursor-pointer text-center my-4'>
