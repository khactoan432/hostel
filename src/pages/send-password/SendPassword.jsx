...
const SendPassword = memo(() => {
      ...
      return (
            ...
            <div>
              <input
                type="text"
                className="w-full py-4 px-6 border border-gray-300 rounded-md background-third placeholder:font-sans placeholder:text-sm placeholder:font-light hover:outline hover:outline-black hover:outline-1"
              ...
              />
                              ...
                              <span className='text-justify w-[18rem]'>
                                    Mật khẩu đã được gửi đến email <span className='font-bold'>q*******@gmail.com</span>
                                    , bạn vui lòng kiểm tra hộp thư.
                              </span>

                              <button
                                    onClick={routeToHome}
                                    className='w-full flex mx-auto justify-center items-center py-4 space-x-2 font-sans font-bold text-white rounded-md background-primary shadow-cyan-100 hover:bg-opacity-90 shadow-sm hover:shadow-lg border transition hover:-translate-y-0.5 duration-150'
                              >
                                    Đăng nhập
                              </button>
