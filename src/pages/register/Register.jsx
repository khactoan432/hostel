                  ...
                  <div className='flex items-center justify-center min-h-screen background-secondary'>
                        ...
                        <div className='relative flex flex-col m-6 space-y-10 bg-white shadow-2xl rounded-2xl md:flex-row md:space-y-0 md:m-0'>
                              ...
                              <div className='p-6 md:p-12'>
                                    {/* <!-- Top Content --> */}
                                    <h2 className='font-mono mb-2 text-4xl font-bold text-center'>Đăng ký</h2>
            ...
            music.
                                    ...
                                    <form onSubmit={handleSubmit(submitHandler)}>
                                          ...
                                          <div className='my-6'>
                                                ...
                                                {/* <input
                  type="password"
                  className="w-full py-4 px-6 border border-gray-300 rounded-md background-third placeholder:font-sans placeholder:font-light hover:outline hover:outline-black hover:outline-1"
                  placeholder="Nhập mật khẩu"
                /> */}
                                          </div>
                                          <div className='my-6'>
                ...
                /> */}
                                          ...
                                          <div className='flex flex-col items-center justify-between mt-6 space-y-6  md:flex-row md:space-y-0 md:space-x-6'>
                                                <div className='font-regular text-hostel hover:cursor-pointer'>
                                                ...
                                                <button
                                                      ...
                                                      className={`${
                                                            isPending && "disable"
                                                      } w-full md:w-auto flex justify-center items-center p-4 space-x-2 font-sans font-bold text-white rounded-md px-9 background-primary shadow-cyan-100 hover:bg-opacity-90 shadow-sm hover:shadow-lg border transition hover:-translate-y-0.5 duration-150`}
                                                >
                                                      {isPending ? (
                                                            <>
                                                                  <svg
                                    ...
                                    {isSuccess && (
                                          <p className='text-center mt-2 text-green-600'>Đăng ký thành công!</p>
                                    )}
                                    {isError && <p className='text-center mt-2 text-red-600'>{error.message}</p>}
                                    {/* <!-- Border --> */}
