...
const EditProfile = (props) => {
      ...
      const editUser = async (userData) => {
            ...
            try {
                  await axios
                        .post(`${baseURL}/edit`, userData, { headers: config })
                  ...
                  <form id='form1' className='my-10 mr-10' onSubmit={handleSubmit}>
                        ...
                        <div className='items-start flex justify-between mt-4'>
                              ...
                              <button
                                    ...
                                    className='text-[#5f6f52] float-right w-3/4 text-left'
                              >
                                    Đổi số điện thoại
                              </button>
                        </div>
                        ...
                        <button
                              type='submit'
                              className='justify-center items-center w-full rounded-md px-3 py-3 mt-8 mb-16 bg-[#5f6f52]'
                        >
                        ...
                        <div
                              ...
                              role='alert'
                        >
                              <div className='ms-3 text-sm font-medium'>Tài khoản đã được cập nhật thành công</div>
                              <button
                                    type='button'
