...
const OwnerDetail = ({ owner, isLiked, phoneNumber }) => {
      ...
      return (
            <div className='flex flex-col items-center gap-4 px-3 py-4 border border-gray-300 rounded-md background-third h-fit bg-[#FEBB02] ml-10 '>
                  <div className='flex flex-col items-center gap-1 mb-2'>
                        <FaRegUserCircle className='w-[48px] h-[45px] text-black' />
