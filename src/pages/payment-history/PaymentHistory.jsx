...
const PaymentHistory = () => {
      ...
      return (
            <div className='col-start-3 col-span-8  gap-3 '>
                  <div className='flex flex-col row-start-1 row-span-7 col-start-3 col-span-6 ml-5 my-10 mb-10'>
                                          ...
                                          payments.map((payment, idx) => {
                                                return (
                                                      <tr
                                                            ...
                                                            key={idx}
                                                      >
                                                            <td className=' border border-slate-300 col-span-4 p-1'>
                                                                  {payment.createdAt}
                                                            </td>
                                                            <td className=' border border-slate-300 col-span-5 p-1'>
                                                                  {payment.post}
                                                            </td>
                                                            <td className=' border border-slate-300 col-span-4 p-1'>
                                                                  {payment.fee}
