...
const Password = (props) => {
      ...
      const changePassword = async (passwordData) => {
            ...
            await axios
                  .post(`${baseURL}/change-password`, passwordData, { headers: config })
                  .then(() => setIsPasswordChange(true))
                  .then(() => login(passwordData));
      };
      useEffect(() => {
            getUsername();
      }, []);
            ...
            <div className='flex flex-col row-start-1 row-span-7 col-start-3 col-span-6 ml-5 my-10'>
                  ...
                  <form id='form2' className='my-10 mr-10' onSubmit={handleChangePassword}>
                        ...
                        <div
                              ...
                              role='alert'
                        >
                              <div className='ms-3 text-sm font-medium'>Mật khẩu đã được thay đổi thành công</div>
                              <button
                                    type='button'
