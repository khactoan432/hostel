...
const PostNew = () => {
      ...
      return (
            <div className='col-start-3 col-span-8 gap-3 max-w-[1536px] mx-auto'>
                  <div className='flex flex-col row-start-1 row-span-7 col-start-3 col-span-6 ml-5 my-10'>
                        <form onSubmit={handleSubmit} className='my-10 mr-10'>
                              <div className='my-8'>
                                    <p className="flex justify-center items-center [font-family:'Poppins-Medium',Helvetica] font-medium text-black text-2xl text-5xl">
                                          Dịch vụ
                                    </p>
                                    <div className='items-center mt-8'>
                                          <label
                                                className="mb-2 block w-full [font-family:'Poppins-Medium',Helvetica] font-medium text-black text-lg"
                                                htmlFor='service'
                                          >
                                                Gói dịch vụ
                                          </label>
                              ...
                              <div className='my-8'>
                                    <p className="[font-family:'Poppins-Medium',Helvetica] font-medium text-black text-2xl">
                                          Địa chỉ cho thuê
                                    </p>
                                    <div className='flex justify-between'>
                                          <div className='items-center mt-8 w-full mr-4'>
                                                ...
                                                <input
                                                      className='px-3 block w-full h-10 outline-none rounded-[4px] bg-[#dfdfdf] border border-solid border-[#cccccc]'
                                                      type='text'
                              ...
                              <div className='my-8'>
                                    ...
                                    <div className='flex justify-between'>
                                          <div className='items-center mt-8 w-full mr-4'>
                                                <p className="mb-2 block w-full [font-family:'Poppins-Medium',Helvetica] font-medium text-black text-lg">
                              ...
                              <button
                                    type='submit'
                                    className='w-full justify-center items-center rounded-md px-3 py-3 mt-8 mb-16 bg-[#5f6f52]'
                              >
                              ...
                              <div
                                    ...
                                    role='alert'
                              >
                                    <div className='ms-3 text-sm font-medium'>Bạn đã tạo tin đăng thành công!</div>
                                    <button
                                          type='button'
