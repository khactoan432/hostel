...
const PostList = ({ postsInfo, totalPost }) => {
      ...
      return (
            <div className='flex flex-grow flex-col gap-4 px-3 py-3 border border-gray-300 rounded-md background-third '>
                  <p className='font-semibold text-lg mb-2'>Tổng {totalPost} kết quả</p>
