...
const Posts = memo(() => {
      ...
      const noActiveFilter = "hover:bg-[#25BEB9] hover:bg-opacity-50 hover:text-white border border-[#25BEB9]";
                              ...
                              <div className='pr-8 mt-4'>
                                    <div className='bg-white w-full rounded-xl py-4 px-4 relative min-h-[600px]'>
                                          ...
                                          <div className='mt-8 lg:mt-12'>
                                                <span className='ml-4'>
                                                      Hiển thị {pageNum === 1 ? 1 : (pageNum - 1) * 7} đến{" "}
                                                      {pageNum * 7 > renderedPost.totalPosts
                                                            ? renderedPost.totalPosts
                                                            : pageNum * 7}{" "}
                                                      của {renderedPost.totalPosts} mục
                                                </span>
