...
const RentalDetail = ({
      ...
      return (
            <div className='flex flex-grow flex-col gap-4 px-3 py-3 border border-gray-300 rounded-md background-third h-fit'>
                  ...
                  <div className='flex items-center gap-1'>
                        <CiLocationOn />
                        <p className='text-sm'>
                              Địa chỉ: {`${address.district}, ${address.ward}, ${address.street_address}`}
                        </p>
                  </div>
                  <div className='flex items-center gap-1'>
                        <BiCategoryAlt />
                  ...
                  <div className='mb-3'>
                        ...
                        <div className='grid grid-cols-2  w-1/2 text-sm'>
                              <div>Liên hệ</div>
                              <div>{owner.full_name ? "Nguyễn Khắc Toàn" : "Thiện Nguyễn"}</div>
                        </div>
                        <div className='bg-gray-300 w-4/5 h-[0.5px] my-2' />
                        <div className='grid grid-cols-2  w-1/2 text-sm'>
                              <div>Số điện thoại</div>
                              <div>{`0${phone_num ? phone_num : "0353846079"}`}</div>
                        </div>
                        <div className='bg-gray-300 w-4/5 h-[0.5px] my-2' />
                        <div className='grid grid-cols-2  w-1/2 text-sm'>
                              <div>Zalo</div>
