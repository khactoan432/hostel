                  ...
                  <div className='flex justify-center items-center min-h-screen background-secondary'>
                        <div className='relative flex flex-col m-6 p-28 justify-between items-center text-center bg-white space-y-4  shadow-2xl rounded-2xl'>
                              ...
                              >
                                    ...
                                    <button className='w-full flex justify-center items-center p-4 space-x-2 font-sans font-bold text-white rounded-md px-9 background-primary shadow-cyan-100 hover:bg-opacity-90 shadow-sm hover:shadow-lg border transition hover:-translate-y-0.5 duration-150'>
                                          {isPending ? (
                                                <>
                                                      <svg
                                    ...
                                    {isError && (
                                          <p className='text-red-600 text-center'>
                                                Có lỗi trong quá trình gửi, vui lòng thử lại!
                                          </p>
                                    )}
                                    {isSuccess && <p className='text-green-600 text-center'>Gửi thành công!</p>}
                              </form>

                              <span>
                                    Bạn đã nhớ mật khẩu?{" "}
                                    <span className='text-hostel'>
