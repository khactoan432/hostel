...
const Header = memo((props) => {
      ...
      useEffect(() => {
            ...
            return () => document.removeEventListener("mousedown", optionSelectionHandler);
      });
      ...
      return (
            <nav className='container-header px-20 py-4 border-b-2 border-b-gray-300'>
                  <div className='wrap-header justify-between items-center text-[15px]'>
                        <span
